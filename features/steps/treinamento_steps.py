...
@then(u'o usuário adiciona o item selecionado ao carrinho e visualiza o item dentro do carrinho')
...
@then(u'o carrinho deverá ter apenas o item "Macacão Sauce Labs" no carrinho')
